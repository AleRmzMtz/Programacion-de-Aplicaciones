 ...
 */
	...
	public class VtnCuadrado extends JFrame implements ActionListener{
		...
		public JFrame vtn;
		private JLabel lbTitulo = new JLabel("El area de un Cuadrado es Lado al cuadrado");
		...
		public void operacion(){ 
					int s = op.areaCuadrado(Integer.parseInt(txtN1.getText()));
					lbResultado.setText(String.format("Cada lado es de %s m. y su area total es de %d m." ,txtN1.getText(),s));
		}
