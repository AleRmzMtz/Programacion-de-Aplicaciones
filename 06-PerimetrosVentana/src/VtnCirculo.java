...
public class VtnCirculo extends JFrame implements ActionListener{
		...
		public JFrame vtn;
		private JLabel lbTitulo = new JLabel("El perimetro de un Circulo es P= PI x diametro ");
		...
		public void operacion(){
			double cir =op.perimetroCirculo(Double.parseDouble(txtN1.getText()));
			lbResultado.setText(String.format("El perimetro del circulo: %f m." ,cir));				
		} 
